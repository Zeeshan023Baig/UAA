        ...
        return (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                <div className="bg-surface border border-border p-8 max-w-md w-full space-y-6 relative shadow-2xl">
                    ...
                    <div className="bg-surface-secondary p-4 rounded-sm space-y-2 text-sm text-muted border border-border">
                    ...
                    <div className="bg-accent/5 border border-accent/20 p-4 rounded-sm">
                        ...
                        <p className="text-muted text-xs mb-3">Send this link to allow them to edit the order:</p>

                        <div className="flex gap-2">
                            <input
                                readOnly
                                value={`${window.location.origin}/order/${lastOrder.id}/edit`}
                                className="bg-surface border border-border text-secondary text-xs p-2 rounded-sm flex-grow outline-none select-all"
                            />
                            <button
                                onClick={() => {
                            ...
                            className="bg-surface hover:bg-accent/10 text-secondary border border-border px-3 rounded-sm transition-colors text-xs font-bold"
                            >
                            Copy
                        </button>
                    </div>
